    ...
    <body>
      ...
      <script>
        ...
        async function searchQuestions() {
          ...
          try {
            const response = await fetch('https://question-1-203z.onrender.com/api/paper/search-replacements', {
              method: 'POST',
              headers: {
        ...
        async function generateAIQuestions() {
          ...
          try {
            const response = await fetch('https://question-1-203z.onrender.com/api/ai-questions/generate-questions', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token
